...
var IDeviceManager = function (udid, opts) {
...
IDeviceManager.prototype._check_cmd = function () {
...
IDeviceManager.prototype._build_cmd = function (options) {
    var cmd = '';
...
IDeviceManager.prototype.list = function (option, cb) {
    var foption = "-l ";
...
IDeviceManager.prototype.isInstalled = function (appName, cb) {
    var self = this;
...
IDeviceManager.prototype.listInstalled = function (cb) {
    this.list(null, cb);
};

IDeviceManager.prototype.listSystem = function (cb) {
    this.list("-o list_system", cb);
};

IDeviceManager.prototype.listAll = function (cb) {
    this.list("-o list_all", cb);
};

IDeviceManager.prototype.remove = function (app, cb) {
...
IDeviceManager.prototype.install = function (app, cb) {
...
IDeviceManager.prototype.installAndWait = function (ipa, app, cb) {
    var self = this;
